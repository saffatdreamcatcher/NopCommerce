...
public partial class AdminMapperConfiguration : Profile, IOrderedMapperProfile
{
    ...
    public AdminMapperConfiguration()
    {
        ...
        CreateVendorsMaps();
        CreateWarehouseMaps();
        CreateAdminHomePageSlidersMaps();
...
#pragma warning restore CS0618
    ...
    protected virtual void CreateSlidersMaps()
    {
        CreateMap<Info, InfoSummaryModel>()

            .ForMember(model => model.AvailableInfos, options => options.Ignore())
            .ForMember(model => model.SelectedStoreIds, options => options.Ignore())
            .ForMember(model => model.AvailableStores, options => options.Ignore());
        CreateMap<InfoSummaryModel, Info>();
    }

    protected virtual void CreateAdminHomePageSlidersMaps()
    {
        CreateMap<HomePageSlider, HomepageSliderModel>();

        CreateMap<HomepageSliderModel, HomePageSlider>();
    }
